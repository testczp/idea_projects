...
/**
 * Created by chenzepeng on 2020/4/6.
 */
...
// finger lets up, off the screen
    ...
    */
    ...
    public void ZoomInAndOut(WebDriver webDriver) throws InterruptedException {
        AndroidDriver driver = (AndroidDriver) webDriver;

        driver.perform(zoomOut(new Point(360, 800), 600));

        Thread.sleep(1000);

        driver.perform(zoomIn(new Point(360, 800), 600));

        Thread.sleep(1000);

        driver.perform(zoomOut(new Point(360, 800).moveBy(0, 250), 300));

        Thread.sleep(1000);

        driver.perform(zoomIn(new Point(360, 800).moveBy(0, -250), 300));
